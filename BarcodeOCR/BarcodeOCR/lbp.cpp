...
void libfacerec::olbp(cv::InputArray src, cv::OutputArray dst) {
...
namespace libfacerec {
  ...
  template <typename _Tp> static
	  inline void varlbp_(cv::InputArray _src, cv::OutputArray _dst, int radius, int neighbors) {
      //get matrices
      Mat src = _src.getMat();
      // allocate memory for result
...
void libfacerec::varlbp(cv::InputArray src, cv::OutputArray dst, int radius, int neighbors) {
  switch (src.getMat().type()) {
...
namespace libfacerec {
  template <typename _Tp> static
	  inline void elbp0(const cv::Mat& src, cv::Mat& dst, int radius, int neighbors) {
...
void libfacerec::elbp0(const cv::Mat& src, cv::Mat& dst, int radius, int neighbors) {
  switch (src.type()) {
...
void libfacerec::elbp(cv::InputArray src, cv::OutputArray dst, int radius, int neighbors) {
  switch (src.type()) {
...
cv::Mat libfacerec::spatial_histogram(cv::InputArray _src, int numPatterns, int grid_x, int grid_y, bool normed) {
  Mat src = _src.getMat();
...
//------------------------------------------------------------------------------
cv::Mat libfacerec::olbp(cv::InputArray src) {
  Mat dst;
  olbp(src, dst);
  return dst;
}

cv::Mat libfacerec::elbp(cv::InputArray src, int radius, int neighbors) {
  Mat dst;
  elbp(src, dst, radius, neighbors);
  return dst;
}

cv::Mat libfacerec::varlbp(cv::InputArray src, int radius, int neighbors) {
  Mat dst;
